...
<div class="submit">
  ...
  <li>March 1, 2016 - June 30, 2016</li>
   ...
   <a href="{{site.url}}/images/Abstract Template Form.docx"><input id="button_submit" class="button_submit" type="button" alt="submit" value="Download Template Form for Abstract"></a>
