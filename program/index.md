...
<p>
	...
	<br>
	<br><a href="{{site.url}}/images/CharlesE.Warren.pdf" class="button_downloadFile"><input id="button_downloadFIle" class="button_downloadFile" type="button" alt="downloadFile" value="Download File"></a>
	<br>
